...
export default function Home() {
  return (
    <div className="">
      <div className="px-4 pt-4 flex justify-between text-textGray font-bold border-b-1 border-borderGray">
        <Link className="pb-3 flex items items-center border-b-4 border-blueDesign" href="">For you</Link>
